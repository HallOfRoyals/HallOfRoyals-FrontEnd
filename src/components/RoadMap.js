        ...
        <div className="row mt-25 align-items-start">
          <div className="col-md-6">
            <div className="glassy-wrapper relative-height-box pt-20 pb-20 pl-20 pr-20">
              ...
              <p className="mt-15">Partner with celebrities and other NFt projects. We will handle the creation of their collections in 3D using our NFT attributes while our community get perks from them</p>

        ...
        <div className="row mt-25 align-items-start">
          <div className="col-md-6">
            <div className="glassy-wrapper relative-height-box pt-20 pb-20 pl-20 pr-20">
              ...
              <p className="mt-15">Create "Hall Of Royals Awards" to recognise and celebrate achievers in the blockchain/metaverse</p>
              <p className="mt-15">Partnering with celebrities and other projects to create their NFT collection using our assets and attributes with our community gaining perks as a result</p>

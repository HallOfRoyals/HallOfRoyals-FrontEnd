    ...
    <section id="roadmap" className="pb-120">
      ...
      <Container style={{ marginTop: -50 }}>
        ...
        <div className="text-center wave-vnxD">
          ...
          <p className="desc-title">Start creating custom-casts + 3D Prints</p>
          <p className="desc mb-20">(Winners & buyers of the "custom-cast reserve" get a personalised sculpt of their face + 3D prints of their Royals)</p>
          ...
          <p className="desc-title mb-20">Hall Of Royals Social website and app (iOS & Android)</p>
          <p className="desc-title">1st Royal Scroll is opened</p>
          <p className="desc">(Royal scrolls contain surprises, exciting updates or just something big going down- think easter eggs)</p>
        </div>
        <div className="text-center wave-vnxD diff">
          <h2>2nd Wave</h2>
          <p className="desc mb-25 text-center">2nd quater 2022</p>
          <p className="desc-title mb-20">New features for the Hall Of Royals</p>
          <p className="desc-title mb-20">Development of community requested features for the Hall Of Royals Social</p>

    ...
    <section id="roadmap" className="glassy-wrapper x-section mt-60 position-relative">
      ...
      <div className="container">
        ...
        <div className="row mt-25 align-items-start">
          <div className="col-md-6 glassy-wrapper relative-height-box pt-20 pb-20 pl-20 pr-20">
          ...
          <div className="col-md-6 text-right">
            <img src={roadmapArt} className="roadmap-art" alt=""/>
          </div>
        </div>
        <ul className="roadmap-ul mt-30">
          <li>
